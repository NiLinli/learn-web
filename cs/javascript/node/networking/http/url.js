...
// 格式化 searchParams
var url1 = 'https://developer.mozilla.org/nilinli?name=nixixi&age=18';

console.log(url.parse(url1).query); // name=nixixi&age=18
console.log(querystring.parse(url.parse(url1).query));      // { name: 'nixixi', age: '18' }
console.log(url.parse(url1, true).query); // { name: 'nixixi', age: '18' }
